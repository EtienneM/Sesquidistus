...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="./css/dropmenu_apple.css" rel="stylesheet" type="text/css" />
	  		...
	  		if (isset($_GET['categorie'])) { 
				if ($_GET['categorie']=="calendrier") {
					if (isset($_GET['page']) and $_GET['page']=="ajout") {
						echo '<link href="./css/calendrier/calendrier_ajout.css" rel="stylesheet" type="text/css" />';
					} else {
						echo '<link href="./css/calendrier/calendrier_consultation.css" rel="stylesheet" type="text/css" />';
					}
				} else if($_GET['categorie']=="galerie_accueil") {
					echo '<link href="./css/gallerie/galerie.css" rel="stylesheet" type="text/css" />';
				} else if($_GET['categorie']=="login" || $_GET['categorie']=="deconnexion") {
					echo '<link href="./css/membres/login.css" rel="stylesheet" type="text/css" />';
				} else if($_GET['categorie']=="event") {
					echo '<link href="./css/event/event.css" rel="stylesheet" type="text/css" />';
				} else if($_GET['categorie']=="sondage" || $_GET['categorie']=="ajout_sondage") {
					echo '<link href="./css/sondage/sondage.css" rel="stylesheet" type="text/css" />';
					echo '<link href="./css/event/event.css" rel="stylesheet" type="text/css" />';
				} else  if($_GET['categorie']=="admin_galerie_album") {
					echo '<link href="./css/galerie/galerie.css" rel="stylesheet" type="text/css" />';
					...
					echo '<link href="./css/forum/forum.css" rel="stylesheet" type="text/css" />';
				} else if($_GET['categorie']=="club" || $_GET['categorie']== "ultimate") {
					echo '<link href="./css/club/club.css" rel="stylesheet" type="text/css" />';
				} else if($_GET['categorie']== "ultimate") {
					echo '<link href="./css/ultimate/ultimate.css" rel="stylesheet" type="text/css" />';
				} else if($_GET['categorie']== "edit_profil" || $_GET['categorie'] == "view_profil") {
					echo '<link href="./css/membres/profil.css" rel="stylesheet" type="text/css" />';
					...
					echo '<link href="./css/inscription/inscription.css" rel="stylesheet" type="text/css" />';
